...
function buildCharts(participantSample){
    d3.json(data).then((newData) => {
        ...
        var barData = [{
            ...
            y: yticks,
            marker: {
                color: ['#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c', '#04a43c']},        
            text: otu_labels,
            orientation: 'h'
          }];
    ...
    var trace1 = {
      ...
      var bubbleLayout = {
        title: {
            text:'All OTU Samples Found',
            font: {color: "black",
              size: 18
            }},
        margin: { t: 30, b: 150},
        xaxis: { title: "OTU ID" },
        yaxis: { title: "OTU Measurement"},
        hovermode: "closest",
      };
      ...
      var gaugeData = [
        {
          ...
          mode: "gauge+number",
          value: washfreq,
          title: { text: "Belly Button Washings per Week", font: { size: 18 } },
          gauge: {
